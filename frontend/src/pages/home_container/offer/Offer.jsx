                ...
                <div className="w-full h-auto rounded-xl bg-zinc-200/30 dark:bg-zinc-800/20 p-8 flex items-center gap-x-3 shadow-md">
                    ...
                    <div className="flex flex-1 flex-col space-y-5">
                        ...
                        <div className="flex items-center gap-x-5">
                            <div className="w-fit border border-dashed px-4 py-1 border-neutral-300 dark:border-neutral-800 bg-red-600/10 dark:bg-red-800/5 rounded-md p-3">
                                {
                                copied
                                    ?
                            ...
                            <button onClick={handleCopy} className="text-x1 text-red-600">
                                <FaCopy/>
                            </button>
                        ...
                        <p className="text-sm text-neutral-400 dark:text-neutral-600 font-normal">
                            Valid till <span className="text-sm font-medium">26th December</span>
                        </p>
                    </div>
                </div>
                <div className="w-full h-auto rounded-xl bg-zinc-200/30 dark:bg-zinc-800/20 p-8 flex items-center gap-x-3 shadow-md">
